const About = () => {
    ...
    return (
        <div id="About">
            ...
            <p className="aboutMe">Outside of work I like to disconnect from the computer for a bit, some of my hobbies include: Fishing when the weather is nice, Gaming, relaxing with my family, and just enjoying the outdoors.
                 I would consider myself a family man, aswell as a pet loving one as well, my family consist of my beautiful wife, 2 beautiful daughters, 3 cats, 2 dogs, 3 ferrets, and a bearded dragon.</p>
